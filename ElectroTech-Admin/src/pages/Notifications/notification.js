  ...
  const handleOkUser = async (values) => {
    ...
    try {
      if (localStorage.getItem("role") == "creator") {
        await axiosClient
          .get("/event/" + values.name_event + "/take_part_in_event/email")
          .then((res) => {
        ...
        <div id="container__notification">
          <Layout>
                ...
                <Menu.Item
                  ...
                  icon={
                    <svg
                      ...
                      class="mr-75 feather feather-send"
                    >
                        ...
                        <List.Item.Meta
                          title={
                            <p
                              ...
                              onClick={() => handleEmailDetail(item.uid)}
                            >
                              {item.title}
                            </p>
                          }
            ...
            <Modal
              ...
              footer={null}
            >
              <h3 style={{ padding: 0, margin: 0, marginBottom: 15 }}>
                <strong>{contentEmail?.title}</strong>
              </h3>
              <Row>
                <Col span="2">
                  <Avatar
                    src={
                      <Image src="https://gw.alipayobjects.com/zos/antfincdn/XAosXuNZyF/BiazfanxmamNRoxxVxka.png" />
                    }
                  />
                </Col>
                <Col span="22">
                  <Row>
                    <h4 style={{ padding: 0, margin: 0, marginLeft: 10 }}>
                      <strong>Send From: {contentEmail?.send_by}</strong>
                    </h4>
                  </Row>
                  <Row>
              ...
              <p
                dangerouslySetInnerHTML={{ __html: contentEmail?.content }}
