          ...
          <Row justify="center" align="top" key="1">
            ...
            <Col span={15}>
              <Carousel autoplay className="carousel-image">
                ...
                <div className="img">
                  <img
                    style={{ width: "100%", height: 250 }}
                    src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/10/banner/vivo-v29-720-220-720x220.png"
                    alt=""
                  />
                </div>
              </Carousel>
            ...
            <Col span={5}>
              <div class="right-banner image-promotion">
                ...
                <a
                  href="https://cellphones.com.vn/laptop-lenovo-ideapad-3-15iau7-82rk001gvn.html"
                  class="right-banner__item"
                >
                  <img
                    src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2023/10/banner/Xiaomi-720-220-720x220-5.png"
              ...
              <div class="countdown-timer">
                <ul class="countdown-list" data-countdown="2020/08/08">
                  <li className="timer-item days">
                    <strong style={{ fontSize: 18 }}>01</strong>
                    <br />
                    <small>Ngày</small>
                  </li>
        ...
        <div className="image-footer">
          <OverPack style={{ overflow: "hidden", height: 800, marginTop: 20 }}>
            ...
            >
              ...
              <Row
                justify="center"
                style={{ marginBottom: 40, fill: "#FFFFFF" }}
              >
                <svg
